...
import { Map, Users, HardDrive, Video, MessageSquare, BarChart3, Server } from 'lucide-vue-next';
import { ref } from 'vue';
...
<template>
  <aside class="w-[52px] border-r border-rp-700 flex flex-col items-center py-4 gap-5 z-40 bg-rp-900">
    <button 
      ...
      :class="activePanel === item.id ? 'text-rp-white border border-rp-700 bg-rp-white/5' : 'text-rp-400 hover:text-rp-200'"
      :title="item.label"
    >
